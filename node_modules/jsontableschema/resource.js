  ...
  _createClass(Resource, [{
    ...
    value: function iter(callback) {
      ...
      if (primaryKey && primaryKey.length > 1) {
        ...
        try {
          for (var _iterator = primaryKey[Symbol.iterator](), _step;
    ...
    value: function map(row) {
      ...
      try {
        for (var _iterator2 = this.schema.headers()[Symbol.iterator](), _step2;
...
function proceed(instance, readStream, callback) {
  var failFast = arguments.length <= 3 || arguments[3] === undefined ? false :
                 arguments[3];
  var skipConstraints = arguments.length <= 4 || arguments[4] === undefined ?
                        false : arguments[4];
  ...
  return new Promise(function(resolve, reject) {
    if (isReadStream(source)) {
      ...
      if (_utilities2.default.isURL(protocol)) {
        var processor = protocol.indexOf('https') !== -1 ? _https2.default :
                        _http2.default;
...
function isReadStream(stream) {
  return stream instanceof _events2.default &&
         _lodash2.default.isFunction(stream.read);
}
...
function cast(instance, reject, callback, errors, items, failFast,
  ...
  try {
    ...
    if (!skipConstraints && instance.primaryHeaders) {
      ...
      _constraints2.default.check_unique_primary(values,
        instance.primaryHeaders, instance.uniqueness);
    }
    callback(values);
  } catch (e) {
    if (failFast === true) {
    ...
    try {
      for (var _iterator3 = e[Symbol.iterator](), _step3;
