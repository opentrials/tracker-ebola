...
var Abstract = function() {
  ...
  _createClass(Abstract, [{
    ...
    value: function cast(value) {
      var skipConstraints = arguments.length <= 1 ||
                            arguments[1] === undefined ? true : arguments[1];
      ...
      if (_utilities2.default.isNull(value)) {
        if (!skipConstraints) {
          _constraints2.default.check_required(this.field.name, value,
            this.isRequired());
        }
        return null;
      }
      ...
      var handler = 'cast' + String(
                    format.charAt(0).toUpperCase() + format.substring(1));
      ...
      if (!skipConstraints) {
        ...
        try {
          for (var _iterator = _lodash2.default.keys(
            this.field.constraints)[Symbol.iterator](), _step;
            ...
            switch (constraint) {
              ...
              default:
                if (this.constraints.indexOf(constraint) === -1) {
                  throw new Error('Field type \'' + String(this.field.type) +
                                  '\' does ' +
                                  ('not support the \'' + String(constraint) +
                                  '\' constraint'));
                }
                _constraints2.default['check_' + String(constraint)](
                  this.field.name, castValue,
...
var StringType = function(_Abstract) {
  ...
  function StringType(field) {
    ...
    var _this = _possibleConstructorReturn(this,
      Object.getPrototypeOf(StringType).call(this, field));

    _this.constraints =
      ['required', 'pattern', 'enum', 'minLength', 'maxLength'];
...
var IntegerType = function(_Abstract2) {
  ...
  function IntegerType(field) {
    ...
    var _this2 = _possibleConstructorReturn(this,
      Object.getPrototypeOf(IntegerType).call(this, field));
  ...
  _createClass(IntegerType, [{
    ...
    value: function beforeCast(value) {
      return String(value).replace(this.regex.group, '')
        .replace(this.regex.percent, '').replace(this.regex.currency, '')
...
var NumberType = function(_IntegerType) {
  ...
  function NumberType(field) {
    ...
    var _this3 = _possibleConstructorReturn(this,
      Object.getPrototypeOf(NumberType).call(this, field));
  ...
  _createClass(NumberType, [{
    ...
    value: function castDefault(value) {
      ...
      if (newValue.indexOf('.') !== -1 &&
          _utilities2.default.isInteger(newValue)) {
...
var BooleanType = function(_Abstract3) {
  ...
  function BooleanType(field) {
    ...
    var _this4 = _possibleConstructorReturn(this,
      Object.getPrototypeOf(BooleanType).call(this, field));
...
var ArrayType = function(_Abstract4) {
  ...
  function ArrayType(field) {
    ...
    var _this5 = _possibleConstructorReturn(this,
      Object.getPrototypeOf(ArrayType).call(this, field));
...
var ObjectType = function(_Abstract5) {
  ...
  function ObjectType(field) {
    ...
    var _this6 = _possibleConstructorReturn(this,
      Object.getPrototypeOf(ObjectType).call(this, field));
  ...
  _createClass(ObjectType, [{
    ...
    value: function castDefault(value) {
      if (_lodash2.default.isObject(value) &&
          ...
          !_lodash2.default.isFunction(value)) {
        return value;
      }
...
var DateType = function(_Abstract6) {
  ...
  function DateType(field) {
    ...
    var _this7 = _possibleConstructorReturn(this,
      Object.getPrototypeOf(DateType).call(this, field));
  ...
  _createClass(DateType, [{
    ...
    value: function castFmt(value) {
      var date = (0, _d3TimeFormat.timeParse)(this.format.replace(/^fmt:/, ''))(
        value);
      if (date == null) {
        throw new Error();
      }
...
var TimeType = function(_DateType) {
  ...
  function TimeType(field) {
    ...
    var _this8 = _possibleConstructorReturn(this,
      Object.getPrototypeOf(TimeType).call(this, field));
...
var DateTimeType = function(_DateType2) {
  ...
  function DateTimeType(field) {
    ...
    var _this9 = _possibleConstructorReturn(this,
      Object.getPrototypeOf(DateTimeType).call(this, field));
...
var GeoPointType = function(_Abstract7) {
  ...
  function GeoPointType(field) {
    ...
    var _this10 = _possibleConstructorReturn(this,
      Object.getPrototypeOf(GeoPointType).call(this, field));
  ...
  _createClass(GeoPointType, [{
    ...
    value: function castObject(value) {
      if (value && (_lodash2.default.isUndefined(value.longitude) ||
                    _lodash2.default.isUndefined(value.latitude))) {
    ...
    value: function typeCheck(value) {
      if (_lodash2.default.isString(value) || _lodash2.default.isArray(value) ||
          _lodash2.default.keys(value).length) {
        return true;
      }
      throw new Error();
    }
    ...
    value: function checkRange() {
      var geoPoint = arguments.length <= 0 || arguments[0] === undefined ? [] :
                     arguments[0];
    ...
    value: function reFormat(geoPoint) {
      ...
      try {
        for (var _iterator2 = geoPoint[Symbol.iterator](), _step2;
...
var GeoJSONType = function(_GeoPointType) {
  ...
  function GeoJSONType(field) {
    ...
    var _this11 = _possibleConstructorReturn(this,
      Object.getPrototypeOf(GeoJSONType).call(this, field));
  ...
  _createClass(GeoJSONType, [{
    key: 'castDefault',
    value: function castDefault(value) {
      return _get(Object.getPrototypeOf(GeoJSONType.prototype), 'castDefault',
...
var AnyType = function(_Abstract8) {
  ...
  function AnyType(field) {
    ...
    var _this12 = _possibleConstructorReturn(this,
      Object.getPrototypeOf(AnyType).call(this, field));
...
function getType(field) {
  ...
  try {
    for (var _iterator3 = _lodash2.default.keys(
      Types)[Symbol.iterator](), _step3;
